                          ...
                          <div className="progress-inner-holder">
                            ...
                            <div className="progress__double">
                              <div className="progress">
                                <div className={`progress__bar ${stat.team1Bar}`} role="progressbar" aria-valuenow={Number(stat.team1Bar.split("-")[2]) || 0} aria-valuemin={0} aria-valuemax={100}></div>
                              </div>
                              <div className="progress">
                                <div className={`progress__bar progress__bar--info ${stat.team2Bar}`} role="progressbar" aria-valuenow={Number(stat.team2Bar.split("-")[2]) || 0} aria-valuemin={0} aria-valuemax={100}></div>
                              </div>
                            </div>
